...
{
    static albert::util::WeakDependency<albert::plugin::mediaremote::IPlugin>
        media_remote(u"mediaremote"_s);
    ...
    else if (media_remote)
    {
        actions.emplace_back(u"playlocal"_s, tr_play_in(), [this]{
            if (media_remote)
                media_remote->pause();
